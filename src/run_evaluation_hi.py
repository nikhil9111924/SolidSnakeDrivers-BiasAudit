"""
run_evaluation_hi.py
====================

This script runs the bias evaluation for HINDI and stores the full completions.
"""
...
def run_evaluation(model_id: str, probes_path: str, output_path: str,
    ...
    with open(output_path, 'w', newline='', encoding='utf-8') as f:
        ...
        for idx, case in enumerate(test_cases, 1):
            ...
            writer.writerow([
                case['template_id'], json.dumps(case['demographics'], ensure_ascii=False), prompt,
    ...
    print("Hindi evaluation complete.")

def main() -> None:
    """
    Main function to parse command-line arguments and start the evaluation.
    """
    parser = argparse.ArgumentParser(description="Evaluate LLM completions for HINDI")
    ...
    parser.add_argument('--output', type=str,
                        ...
                        help='CSV file to write HINDI results to')
